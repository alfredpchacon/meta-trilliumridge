...
typedef enum
{
    ...
    ORION_PKT_PRIVATE_31,            //!< Reserved packet identifier
    ORION_PKT_PRIVATE_32,            //!< Reserved packet identifier
    ...
    ORION_PKT_ATTOLLO_SETTINGS,      //!< Attollo-specific camera settings
    ORION_PKT_VIDEO_OPTIONS = 0x70,  //!< Settings for changing video processing and display
    ...
    ORION_PKT_CROWN_MODE = 0xB0,     //!< settings telemetry reporting modes
    ...
    ORION_PKT_SENSOR_DATA = 0xD0,    //!< Raw sensor data from the Orion Crown board.
...
typedef enum
{
    ...
    ORION_MODE_TRACK = 0x31,             //!< Commands give the angular position of the track box in the camera image as fraction from center, bound these numbers -0.5 to 0.5
    ORION_MODE_NUDGE_TRACK = 0x32,       //!< Nudge the track box by a percentage of FOV
    ORION_MODE_CALIBRATION = 0x40,       //!< Drives the pan and tilt axes to calibrate the stabilization gyros
    ORION_MODE_NULL_GYROS = 0x41,        //!< Drives the pan and tilt axes to null the stabilization gyros
...
typedef enum
{
    ...
    LASER_TYPE_DESIGNATOR_6x     //!< Laser Designator Extender 6x
} OrionLaserType_t;
